def get_ftppackage(appid, taskid):
    '''
    ...
    __salt__['cp.get_file']('salt://scripts/Ionic.Zip.dll', r'c:\windows\temp\Ionic.Zip.dll')
...
def update_site(appid, taskid):
    ...
    .. code-block:: bash
        ...
        salt '*' publish.update_site 'api.app.ymatou.com' taskid
    '''
